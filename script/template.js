    ...
    return `
        <div class="open-close-dialog" onclick="toggleTaskOverlay('task-dialog')" id="task-overlay-${i.id}">
            <div class="task-overlay" onclick="stopPropagation(event)">
                ...
                <main id="task-main-overlay-${i.id}"></main>
                ...
                <footer>
                    ...
                    <button class="main-task-edit" onclick="toggleEditTaskOverlay(${i.id})">
                        <div class="edit-logo">
...
function taskMainOverlayTemp(i){    
    return`
        <h2>${i.name}</h2>
...
function editTaskOverlayTemp(){
    return`
        ...
        <textarea class="change-desc" id="change-desc" placeholder="Write your Description"></textare
        <label class="task-info-type">Due date</label>
        <div class="date-input">
            <input type="date" id="input-date">
            <button for"input-date" onclick="openDatePicker()">
        ...
        <div class="change-subtasks-list">
