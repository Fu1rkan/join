...
function boardAddTaskTemplate(progress) {
    return `
        <div class="add-task-card" onclick="event.stopPropagation(); closeDropdownMenus(event)">
                ...
                <div class="add-task-form-main">
                    <section class="add-task-form-left">
                        <div class="h-80" onclick="event.stopPropagation()">
                                ...
                                <div class="add-tast-form-input-required-container">
                                    <input id="add_task_title" type="text"
                                        ...
                                        placeholder="Enter a Title" onfocus="highlightInputFields('add_task_title')" maxlength="40" onkeyup="checkRequiredInputs('add_task_title')">
                                    <div class="h-16">
                                        <p id="required_msg_title" class="required-msg d_none">This field
                                            is required</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="h-80" onclick="event.stopPropagation()">
                                <label for="add_task_due_date" class="add-task-due-date-label">
                                    ...
                                    <div class="add-task-form-input-required-container">
                                        ...
                                        <input id="add_task_due_date"
                                            ...
                                            onclick="openCalender('add_task_due_date')"
                                            onfocus="highlightInputFields('add_task_due_date')" onchange="checkRequiredInputs('add_task_due_date')">
                                    </div>
                                    <svg class="add-task-due-date-label-calender-svg" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <mask id="mask0_387837_2602" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                ...
                                <div class="h-16">
                                            <p id="required_msg_due_date" class="required-msg d_none">This
                                                field is required</p>
                                        </div>
                            </div>
                    </section>
                    ...
                    <section id="add_task_form_right" class="add-task-form-right">
                        ...
                        <div id="add_task_form_assigned_to_section" class="add-task-form-assigned-to-section h-80"
                                ...
                                <label for="add_task_assigned_to" class="add-task-assigned-to-category-label"
                                   >
                                    ...
                                    <input id="add_task_assigned_to"
                                        class="w-100 add-task-form-default-inputs add-task-form-input-placeholder-black"
                                        type="text" onfocus="highlightInputFields('add_task_assigned_to')" onkeyup="filterInputValue()"  onclick="toggleAssignedToContactList()"
                                        placeholder="Select contacts to assign">
                                    <div id="add_task_form_assigned_to_arrow_svg"
                                        class="add-task-form-assigned-to-arrow-down-svg"
                                        onclick="event.stopPropagation()">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
                                            <mask id="mask0_387837_1520" style="mask-type:alpha"
                                ...
                                <div class="add-task-form-assigned-to-dropdown">
                                    <ul id="add_task_form_assigned_to_dropdown_contacts"
                                        onclick="event.stopPropagation()"
                                        class="add-task-form-assigned-to-dropdown-contacts d_none">
                                    </ul>
                                </div>
                                <div id="current_assigned_to_contacts"
                                    class="current-assigned-to-contacts-container d_none">
                                </div>
                            </div>
                        <div class="add-task-form-assigned-to-section h-80" onclick="event.stopPropagation()">
                                <label for="add_task_category" class="add-task-assigned-to-category-label"
                                    ...
                                    <input id="add_task_category"
                                        ...
                                        onfocus="highlightInputFields('add_task_category')" readonly onclick="toggleCategoryList()">
                                    <div id="add_task_form_category_arrow_svg"
                                        class="add-task-form-assigned-to-arrow-down-svg"
                                        onclick="event.stopPropagation()">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
                                ...
                                <div class="required-msg-category h-16">
                                    <p id="required_msg_category" class="required-msg d_none">This field is required</p>
                                </div>
                        ...
                        <div class="subtasks-container" onclick="event.stopPropagation()">
                                <label for="add_task_subtasks" class="add-task-assigned-to-category-label">
                                    ...
                                    <div id="add_task_form_subtasks_btns" class="add-task-form-subtasks-btns d_none">
                                        <button onclick="resetAddTaskSubtasksInputField()" type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
                                                <mask id="mask0_75601_14760" style="mask-type:alpha"
                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                    <rect width="24" height="24" fill="#D9D9D9" />
                                                </mask>
                                        ...
                                        <button onclick="setSubtask()">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none">
                                                <mask id="mask0_75601_14762" style="mask-type:alpha"
                                                    maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                                    <rect width="24" height="24" fill="#D9D9D9" />
                                                </mask>
            ...
            <p class="task-added-overlay-board d_none" id="task-added-overlay-board">
                Task added to Board
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    <path d="M22.9544 4.77273L22.9545 25.2271C22.9538 25.8296 22.7142 26.4074 22.2881 26.8334C21.862 27.2595 21.2843 27.4992 20.6817 27.4998L16.1363 27.4998C15.5338 27.4992 14.956 27.2595 14.53 26.8334C14.1039 26.4074 13.8642 25.8296 13.8636 25.2271L13.8636 4.77273C13.8642 4.17015 14.1039 3.59243 14.53 3.16635C14.956 2.74026 15.5338 2.50062 16.1363 2.50002L20.6817 2.50002C21.2843 2.50062 21.862 2.74026 22.2881 3.16635C22.7142 3.59243 22.9538 4.17015 22.9544 4.77273ZM16.1363 25.2271L20.6817 25.2271L20.6817 4.77273L16.1363 4.77273L16.1363 25.2271ZM16.1363 4.77273L16.1363 25.2271C16.1357 25.8296 15.8961 26.4073 15.47 26.8334C15.0439 27.2595 14.4662 27.4991 13.8636 27.4997L9.31823 27.4997C8.71566 27.4991 8.13794 27.2595 7.71185 26.8334C7.28577 26.4073 7.04613 25.8296 7.04553 25.227L7.04553 4.7727C7.04613 4.17013 7.28577 3.59241 7.71185 3.16632C8.13793 2.74024 8.71566 2.5006 9.31823 2.5L13.8636 2.5C14.4662 2.5006 15.0439 2.74024 15.47 3.16632C15.8961 3.59241 16.1357 4.17015 16.1363 4.77273ZM9.31823 25.227L13.8636 25.2271L13.8636 4.77273L9.31823 4.7727L9.31823 25.227ZM9.31823 4.7727L9.31823 25.227C9.31763 25.8296 9.07799 26.4073 8.65191 26.8334C8.22582 27.2595 7.6481 27.4991 7.04553 27.4997L2.50012 27.4997C1.89755 27.4991 1.31983 27.2595 0.893741 26.8334C0.467657 26.4073 0.228019 25.8296 0.227417 25.227L0.227416 4.7727C0.228018 4.17013 0.467656 3.59241 0.89374 3.16632C1.31982 2.74024 1.89755 2.5006 2.50012 2.5L7.04553 2.5C7.6481 2.5006 8.22582 2.74024 8.6519 3.16632C9.07799 3.59241 9.31763 4.17013 9.31823 4.7727ZM2.50012 25.227L7.04553 25.227L7.04553 4.7727L2.50012 4.7727L2.50012 25.227Z" fill="white"/>
                    <path d="M29.7726 4.77298L29.7726 25.2273C29.772 25.8299 29.5323 26.4076 29.1062 26.8337C28.6802 27.2598 28.1024 27.4994 27.4999 27.5L22.9545 27.5C22.3519 27.4994 21.7742 27.2598 21.3481 26.8337C20.922 26.4076 20.6824 25.8296 20.6817 25.2271L20.6817 4.77273C20.6823 4.17015 20.922 3.59268 21.3481 3.1666C21.7742 2.74051 22.3519 2.50088 22.9544 2.50027L27.4999 2.50027C28.1024 2.50088 28.6801 2.74051 29.1062 3.1666C29.5323 3.59268 29.772 4.1704 29.7726 4.77298ZM22.9545 25.2271L27.4999 25.2273L27.4999 4.77298L22.9544 4.77273L22.9545 25.2271Z" fill="white"/>
                </svg>
            </p>
        </div>
    `
