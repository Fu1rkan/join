...
function taskTemp(i) {
    return `
        <div class="task" draggable="true" ondragstart="startDragging(${i.id})" onclick="toggleTaskOverlay(${i.id})" ontouchstart="startPress(${i.id})" ontouchend="endPress(${i.id})" id="task-id-${i.id}">
