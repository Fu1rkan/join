        ...
        <div class="contact-info-big-name-edit-container">
            ...
            <div class="contact-info-big-edit">
                ...
                <button class="contact-btn contact-delete-btn"
                    onclick="openDeleteContactOverlay('${contact.name}', '${contact.email}')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
function showContactEditCard(toEditContact) {
    ...
    <section id="overlay_edit_contact_card" class="overlay-card" onclick="event.stopPropagation()">
            ...
            <section class="add-contact-content-container">
                ...
                <form action="" class="create-form" onsubmit="return false">
                    ...
                    <section class="edit-contact-d-s-buttons">
                        <button class="edit-contact-delete-btn" onclick="closeOverlay(); openDeleteContactOverlay('${toEditContact.name}','${toEditContact.email}')">
        ...
        <div id="responsiv_contact_edit_small_menu" class="responsiv-edit-delete-menu d_none" onclick="event.stopPropagation()">
            ...
            <button onclick="openDeleteContactOverlay('${toEditContact.name}', '${toEditContact.email}'); closeResponsiveContactEditMenu(0)">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
function renderDeleteContactOverlay(name, email) {
    ...
    return `
        <button onclick="closeDeleteContactOverlay()">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <mask id="mask0_75592_9957" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                    width="24" height="24">
        ...
        <button onclick="deleteCurrentContact('${name}', '${email}')">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <mask id="mask0_75592_9963" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                    width="24" height="24">
                    <rect width="24" height="24" fill="#ffffff" />
                </mask>
