...
<main>
    ...
    <label class="task-info-type">Title</label>
    <input type="text" placeholder="">

    <label class="task-info-type">Description</label>
    <input type="text" placeholder="">

    <label class="task-info-type">Due date</label>
    <input type="date" placeholder="">

    <label class="task-info-type">Priority</label>
    <div>
        <button>
            <p>Urgent</p>
    ...
    <label class="task-info-type">Assigned to</label>
    <form action="">
        <input type="text">
        <button>
    ...
    <label class="task-info-type" for="">Subtasks</label>
    <form action="">
        <input type="text">
        <div>
