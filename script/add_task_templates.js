...
function getCurrentAssignedContactTemplate(index) {
    return `
        <div class="current-assigned-to-contact" style="background-color:${currentAssignedTo[index].fillColor}">
...
function getAddTaskAssignedToListItem(array, index) {
    return `
        <li id="add_task_assigned_to_contact_${index}"
...
function getSubtaskTemplate(index) {
    return `
        <li id="current_subtask_li_${index}" ondblclick="changeCurrentSubtask(${index})"
            ...
            <div class="add-task-form-subtasks-dropdown-subtasks-item">
                <div class="d_f">
                    ...
                    <p id="current_subtask_${index}" class="add-task-form-subtasks-dropdown-subtasks-list-item-subtask-title">${escapeHTML(currentCreatedSubtasks[index].name)}</p>
                </div>
                <div id="current_subtask_rough_menu_btns${index}" class="add-task-form-subtasks-dropdown-subtasks-btns">
                    <button onclick="changeCurrentSubtask(${index})">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <mask id="mask0_75601_14818" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="24" height="24">
                    ...
                    <div class="add-task-subtasks-dropdown-subtasks-item-seperator"></div>
                    <button onclick="deleteCurrentSubtask(${index})">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <mask id="mask0_75601_14820" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                width="24" height="24">
                                <rect width="24" height="24" fill="#D9D9D9" />
                            </mask>
                ...
                <label id="label_current_subtask_${index}" for="change_current_element_${index}" class="d_none">
                    ...
                    <section class="add-task-form-subtasks-dropdown-subtasks-edit-btns">
                        ...
                        <button onclick="saveChangedSubtask(${index})">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <mask id="mask0_75601_14779" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                    width="24" height="24">
                                    <rect width="24" height="24" fill="#D9D9D9" />
                                </mask>
